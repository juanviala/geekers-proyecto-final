...
const CartIcon = () => {
  ...
  return (
            <div>
              <div className="badge">{ cartAmount }</div>
                <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" className="bi bi-bag-check" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
